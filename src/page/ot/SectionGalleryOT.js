    ...
    return (
        <div>
           ...
           <div id="gallery" className="surface-section px-4 py-8 md:px-6 lg:px-8 border-top-1 surface-border">
                <div>
                    <div className="card">
                        <h2 className="mb-3 font-bold text-4xl text-900">Imagenes de Ingreso a taller</h2>
                        ...
                        <div className="grid">
                            {
                                images && images.map((image, index) => {
                                    ...
                                    return (
                                        <div className="col-12 md:col-6 lg:col-2 mb-5 lg:mb-0">
